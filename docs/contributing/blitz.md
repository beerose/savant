Savant is based on [Blitz.js](https://github.com/blitz-js/blitz).
...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/savant
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/savant_test
```
